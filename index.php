...
<div class="container_new" style=background-image:url('9.jpg');>
<div class="container">
...
<div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        <h5 class="card-title">Para Betina Pengikut Iblis</h5>
  ...
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        <h5 class="card-title">Jagat Arwah</h5>
  ...
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        <h5 class="card-title">Keramat</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        <h5 class="card-title">Menjelang Magrib</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        <h5 class="card-title">Inhuman kiss</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
      </div>
    </div>
  </div>
